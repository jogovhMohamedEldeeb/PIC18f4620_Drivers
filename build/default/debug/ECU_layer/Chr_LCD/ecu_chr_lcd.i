...
# 1 "ECU_layer/Chr_LCD/../../MCAL_layer/GPIO/hel_gpio.h" 1
# 13 "ECU_layer/Chr_LCD/../../MCAL_layer/GPIO/hel_gpio.h"
...
# 13 "ECU_layer/Chr_LCD/../../MCAL_layer/GPIO/hel_gpio.h" 2
...
# 14 "ECU_layer/Chr_LCD/../../MCAL_layer/GPIO/hel_gpio.h" 2

# 1 "ECU_layer/Chr_LCD/../../MCAL_layer/GPIO/../device_config.h" 1
# 15 "ECU_layer/Chr_LCD/../../MCAL_layer/GPIO/hel_gpio.h" 2

# 1 "ECU_layer/Chr_LCD/../../MCAL_layer/GPIO/hal_gpio_cfg.h" 1
# 16 "ECU_layer/Chr_LCD/../../MCAL_layer/GPIO/hel_gpio.h" 2
# 38 "ECU_layer/Chr_LCD/../../MCAL_layer/GPIO/hel_gpio.h"
typedef enum{
    GPIO_LOW = 0,
    GPIO_HIGH
}logic_t;
...
# 63 "ECU_layer/Chr_LCD/ecu_chr_lcd.c"
Std_ReturnType lcd_4bit_send_command(const chr_lcd_4bit_t *lcd, uint8 command){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(((void*)0) == lcd){
        ret = (Std_ReturnType)0x00;
...
# 92 "ECU_layer/Chr_LCD/ecu_chr_lcd.c"
Std_ReturnType lcd_4bit_send_char_data(const chr_lcd_4bit_t *lcd, uint8 data){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(((void*)0) == lcd){
        ret = (Std_ReturnType)0x00;
...
# 123 "ECU_layer/Chr_LCD/ecu_chr_lcd.c"
Std_ReturnType lcd_4bit_send_char_data_pos(const chr_lcd_4bit_t *lcd,uint8 row, uint8 column, uint8 data){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(((void*)0) == lcd){
        ret = (Std_ReturnType)0x00;
...
# 166 "ECU_layer/Chr_LCD/ecu_chr_lcd.c"
Std_ReturnType lcd_4bit_send_string_pos(const chr_lcd_4bit_t *lcd, uint8 row, uint8 column, uint8 *str){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(((void*)0) == lcd){
        ret = (Std_ReturnType)0x00;
...
# 191 "ECU_layer/Chr_LCD/ecu_chr_lcd.c"
Std_ReturnType lcd_4bit_send_custom_char(const chr_lcd_4bit_t *lcd, uint8 row, uint8 column,
                                         const uint8 _chr[], uint8 mem_pos){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    uint8 lcd_counter = 0;
...
# 215 "ECU_layer/Chr_LCD/ecu_chr_lcd.c"
Std_ReturnType lcd_8bit_intialize(const chr_lcd_8bit_t *lcd){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    uint8 l_data_pins_counter = 0;
    if(((void*)0) == lcd){
...
# 252 "ECU_layer/Chr_LCD/ecu_chr_lcd.c"
Std_ReturnType lcd_8bit_send_command(const chr_lcd_8bit_t *lcd, uint8 command){
    Std_ReturnType ret = (Std_ReturnType)0x01;
...
# 280 "ECU_layer/Chr_LCD/ecu_chr_lcd.c"
Std_ReturnType lcd_8bit_send_char_data(const chr_lcd_8bit_t *lcd, uint8 data){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    uint8 l_pin_counter = 0;
    if(((void*)0) == lcd){
...
# 310 "ECU_layer/Chr_LCD/ecu_chr_lcd.c"
Std_ReturnType lcd_8bit_send_char_data_pos(const chr_lcd_8bit_t *lcd,uint8 row, uint8 column, uint8 data){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(((void*)0) == lcd){
        ret = (Std_ReturnType)0x00;
...
# 330 "ECU_layer/Chr_LCD/ecu_chr_lcd.c"
Std_ReturnType lcd_8bit_send_string(const chr_lcd_8bit_t *lcd, uint8 *str){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(((void*)0) == lcd){
        ret = (Std_ReturnType)0x00;
...
# 353 "ECU_layer/Chr_LCD/ecu_chr_lcd.c"
Std_ReturnType lcd_8bit_send_string_pos(const chr_lcd_8bit_t *lcd, uint8 row, uint8 column, uint8 *str){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(((void*)0) == lcd){
        ret = (Std_ReturnType)0x00;
...
# 376 "ECU_layer/Chr_LCD/ecu_chr_lcd.c"
Std_ReturnType lcd_8bit_send_custom_char(const chr_lcd_8bit_t *lcd, uint8 row, uint8 column,
                                         const uint8 _chr[], uint8 mem_pos){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    uint8 lcd_counter = 0;
...
# 401 "ECU_layer/Chr_LCD/ecu_chr_lcd.c"
Std_ReturnType convert_uint8_to_string(uint8 value, uint8 *str){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(((void*)0) == str){
        ret = (Std_ReturnType)0x00;
...
# 484 "ECU_layer/Chr_LCD/ecu_chr_lcd.c"
static Std_ReturnType lcd_4bit_send_enable_signal(const chr_lcd_4bit_t *lcd){
    Std_ReturnType ret = (Std_ReturnType)0x01;
...
# 538 "ECU_layer/Chr_LCD/ecu_chr_lcd.c"
static Std_ReturnType lcd_4bit_set_cursor(const chr_lcd_4bit_t *lcd, uint8 row, uint8 coulmn){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    coulmn--;
    switch(row){
