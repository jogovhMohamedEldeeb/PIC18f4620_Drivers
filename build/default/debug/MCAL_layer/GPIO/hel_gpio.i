...
# 10 "MCAL_layer/GPIO/hel_gpio.c"
# 1 "MCAL_layer/GPIO/hel_gpio.h" 1
# 13 "MCAL_layer/GPIO/hel_gpio.h"
...
# 13 "MCAL_layer/GPIO/hel_gpio.h" 2
...
# 14 "MCAL_layer/GPIO/hel_gpio.h" 2

# 1 "MCAL_layer/GPIO/../device_config.h" 1
# 15 "MCAL_layer/GPIO/hel_gpio.h" 2

# 1 "MCAL_layer/GPIO/hal_gpio_cfg.h" 1
# 16 "MCAL_layer/GPIO/hel_gpio.h" 2
# 38 "MCAL_layer/GPIO/hel_gpio.h"
typedef enum{
    GPIO_LOW = 0,
    GPIO_HIGH
}logic_t;
...
# 10 "MCAL_layer/GPIO/hel_gpio.c" 2
        ...
        switch(_pin_config->direction)
         {
            case GPIO_DIRECTION_OUTPUT :
                (*tris_regiters[_pin_config->port] &= ~((uint8) 1 << _pin_config->pin));
                break;
...
Std_ReturnType gpio_pin_get_direction_status(const pin_config_t *_pin_config, direction_t *direction_status){
   ...
   if(((void*)0) == _pin_config|| ((void*)0) == direction_status || _pin_config->pin > 8 - 1){
      ...
      *direction_status = ((*tris_regiters[_pin_config->port] >> _pin_config->pin) & (uint8) 1);
   }
   return ret;
}
# 78 "MCAL_layer/GPIO/hel_gpio.c"
Std_ReturnType gpio_pin_write_logic(const pin_config_t *_pin_config, logic_t logic){
     Std_ReturnType ret = (Std_ReturnType)0x01;

     if(((void*)0) == _pin_config || _pin_config->logic > 8 - 1){
         ret = (Std_ReturnType)0x00;
     }
     else{
         switch(logic){
             case GPIO_LOW:
                 (*lat_regiters[_pin_config->port] &= ~((uint8) 1 << _pin_config->pin));
                 break;
             case GPIO_HIGH:
                 (*lat_regiters[_pin_config->port] |= ((uint8) 1 << _pin_config->pin));
                 break;
...
# 108 "MCAL_layer/GPIO/hel_gpio.c"
Std_ReturnType gpio_pin_read_logic(const pin_config_t *_pin_config, logic_t *logic){
   Std_ReturnType ret = (Std_ReturnType)0x01;
   ...
   if(((void*)0) == _pin_config|| ((void*)0) == logic || _pin_config->pin > 8 - 1){
      ...
      *logic = ((*tris_regiters[_pin_config->port] >> _pin_config->pin) & (uint8) 1);
   }
   return ret;
}
# 128 "MCAL_layer/GPIO/hel_gpio.c"
Std_ReturnType gpio_pin_toggle_logic(const pin_config_t *_pin_config){
     Std_ReturnType ret = (Std_ReturnType)0x01;
...
# 149 "MCAL_layer/GPIO/hel_gpio.c"
Std_ReturnType gpio_pin_intialize(const pin_config_t *_pin_config){
     Std_ReturnType ret = (Std_ReturnType)0x01;
...
# 172 "MCAL_layer/GPIO/hel_gpio.c"
Std_ReturnType gpio_port_direction_intialize(port_index_t port, uint8 direction){
     Std_ReturnType ret = (Std_ReturnType)0x01;
     if(port > 5 -1){
         ret = (Std_ReturnType)0x00;
...
# 192 "MCAL_layer/GPIO/hel_gpio.c"
Std_ReturnType gpio_port_get_direction_status(port_index_t port, uint8 *direction_status ){
     Std_ReturnType ret = (Std_ReturnType)0x01;
...
# 213 "MCAL_layer/GPIO/hel_gpio.c"
Std_ReturnType gpio_port_write_logic(port_index_t port, uint8 logic){
     Std_ReturnType ret = (Std_ReturnType)0x01;
...
# 235 "MCAL_layer/GPIO/hel_gpio.c"
Std_ReturnType gpio_port_read_logic(port_index_t port, uint8 *logic){
     Std_ReturnType ret = (Std_ReturnType)0x01;
...
# 255 "MCAL_layer/GPIO/hel_gpio.c"
Std_ReturnType gpio_port_toggle_logic(port_index_t port){
     Std_ReturnType ret = (Std_ReturnType)0x01;
