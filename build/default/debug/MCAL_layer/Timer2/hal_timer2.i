...
# 1 "MCAL_layer/Timer2/../GPIO/hel_gpio.h" 1
# 15 "MCAL_layer/Timer2/../GPIO/hel_gpio.h"
# 1 "MCAL_layer/Timer2/../GPIO/../device_config.h" 1
# 15 "MCAL_layer/Timer2/../GPIO/hel_gpio.h" 2

# 1 "MCAL_layer/Timer2/../GPIO/hal_gpio_cfg.h" 1
# 16 "MCAL_layer/Timer2/../GPIO/hel_gpio.h" 2
# 38 "MCAL_layer/Timer2/../GPIO/hel_gpio.h"
typedef enum{
    GPIO_LOW = 0,
    GPIO_HIGH
}logic_t;
...
# 8 "MCAL_layer/Timer2/hal_timer2.c" 2
    ...
    static void (* TMR2InterruptHandler)(void) = ((void*)0);


static uint16 timer2preload = 0;
Std_ReturnType Timer2_Init(const timer2_t *_timer){
